...
import __vite__cjsImport1_react from "/node_modules/.vite/deps/react.js?v=17b4195c"; const useState = __vite__cjsImport1_react["useState"]; const useEffect = __vite__cjsImport1_react["useEffect"];
import {
  Github,
  Key,
  Folder,
  ...
  return /* @__PURE__ */ jsxDEV("div", { className: "bg-white/5 border border-white/10 rounded-3xl p-6 sm:p-8 space-y-6", children: [
    ...
    /* @__PURE__ */ jsxDEV("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [
      ...
      /* @__PURE__ */ jsxDEV("div", { className: "space-y-1.5", children: [
        ...
        /* @__PURE__ */ jsxDEV("p", { className: "text-[10px] text-emerald-400 font-mono", children: [
          "※ 音声データはリポジトリ内の ",
          /* @__PURE__ */ jsxDEV("code", { className: "bg-white/10 px-1 py-0.5 rounded text-emerald-300", children: "audio/" }, void 0, false, {
            fileName: "/app/applet/src/components/GitHubSettings.tsx",
            lineNumber: 407,
            columnNumber: 29
          }, this),
